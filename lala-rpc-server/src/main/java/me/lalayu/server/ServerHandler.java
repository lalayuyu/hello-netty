...
public class ServerHandler extends SimpleChannelInboundHandler<RequestMessagePacket> {
    ...
    @Autowired
    public ServerHandler(MethodMatcher methodMatcher, MethodArgumentConverter methodArgumentConverter) {
        this.methodMatcher = methodMatcher;
        this.methodArgumentConverter = methodArgumentConverter;
    }
    ...
    protected void channelRead0(ChannelHandlerContext ctx, RequestMessagePacket packet) throws Exception {
        ...
        convertInput.setArguments(matcherInput.getMethodArgumentSize() > 0 ? Lists.newArrayList(Objects.requireNonNull(methodArguments)) : Lists.newArrayList());
